    ...
    <>
      ...
      <div className='app__footer-cards'>
        <div className='app__footer-card'>
          ...
          <a href="mailto:lucagennaro91@gmail.com" className='p-text'>lucagennaro91@gmail.com</a>
        </div>
        <div className='app__footer-card'>
          <img src={images.mobile} alt="email" />
          <a href="tel: +39 380 382 3744" className='p-text'>+39 380 382 3744</a>
        </div>
      </div>
      ...
      {!isFormSubmitted ?
        <div className='app__footer-form app__flex'>
          ...
          <button type='button' className='p-text' onClick={handleSubmit} disabled={!isFormValid}>
